...
import { FaBoxOpen, FaCalendarAlt, FaChartBar, FaMotorcycle, FaRegCreditCard, FaSignOutAlt, FaTasks, FaUserCog, FaUsers, FaUsersCog } from 'react-icons/fa';
                        ...
                        <ul className="menu w-full grow px-2 pt-4">
                            ...
                            {role === 'admin' && (
                                <>
                                    ...
                                    <li className="mb-2">
                                        <NavLink
                                            to="/dashboard/admin/users-maanagement"
                                            className="flex items-center gap-4 px-4 py-3 rounded-lg transition-all duration-200 hover:bg-secondary/10 hover:text-secondary data-[active]:bg-primary data-[active]:text-white"
                                        >
                                            <FaUsers className="size-6 flex-shrink-0" />
                            ...
                            {role !== 'admin' && (
                                <li className="mt-auto mb-4">
                                    <NavLink to="/dashboard/become-decorator" className="w-full">
                                        <button
